Отлично! Вот твой README.md с дополнением про **View** и **события**. Я вставил новый блок в конец документа, чтобы он логично продолжал уже существующую документацию:
